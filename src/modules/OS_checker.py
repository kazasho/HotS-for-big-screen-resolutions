...
logger_OS = LoggerFactory.get_logger("OS_Checker.log", log_level="NOTSET")
logger_OS.debug("OS_Checker: Logging setup complete")
...
def OS_checker():
    ...
    if OS == 'Windows':
        logger_OS.info("Detected OS: Windows")
